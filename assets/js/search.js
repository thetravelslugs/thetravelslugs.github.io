    ...
    function displaySearchResults(results, store) {
        ...
        if (results.length) { // Are there any results?
            ...
            for (var i = 0; i < results.length; i++) {  // Iterate over the results
                ...
                appendString += '<div class="post posts-details">';
                appendString += '<li><a href="' + item.url + '"><h3 class="h5">' + item.title + '</h3></li>';
                appendString += '<p class="text-muted">' + item.description + '</p></a>';
                appendString += '</div>';
            }
